...
[*Github*]{style="color:orange"} platform for managing and sharing *git* repositories
...
1.  Create a new file -  another Quatro file that is a demonstration of how to find the total streamflow and total precipitation in each year and % of precip that becomes streamflow
and then computes mean and standard deviation of across years. You can use the p301.csv file for this.
