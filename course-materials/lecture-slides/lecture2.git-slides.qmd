...
*Git* is a free and open source distributed version control system. Its the most popular, used by millions

*Git* works with many code-bases - not just R, but also Python, C, Java, etc. and can be used also for data storage, websites, and more
