...
Breaking your instructions down into individual pieces identifying instructions that can be reused
...
-   [Submit on Canvas as GROUP submission for Assignment 1]{style="color: maroon;"}
