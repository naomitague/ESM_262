...
Lets start with the basics of how you do repetition - 
  * the *for* loop - used in many languages
...
Generating test data is a helpful way to check your code. 
Take advantage of built-in R functions to sample from distributions as we did last class
