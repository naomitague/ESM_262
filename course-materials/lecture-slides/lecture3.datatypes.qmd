...
The *syntax* of **sprintf** is a bit weird but it is very useful for creating informative text and plot titles
of course you can also use **paste** and **paste0** but **sprintf** gives you more control over formatting

AND *sprintf* syntax is used in many other programing languages
...
* review 
* also create data for testing your code
...
## <span style="color:orange">Installing packages from GitHub</span>
 
 you can install user packages from *github* - you need the *devtools* library to do this
 
 install_github("naomitague/rainbow")
 
 *Important* this doesn't create a *repo* of rainbow inside you working repository - so its safe!
 But you cannot *clone* or create a *repo* inside the directory structure of another one
