...
Try it with *hello.qmd* - change to html

[Indentation Matters in YAML]{style="color: orange;"}
...
Also used in 
-   GitHub Actions - automate code testing and deployment of website
...
# Format in YAML header {.scrollable}
...
```{r, load-packagesalt, include=TRUE, echo=TRUE}
library(tidyverse)
library(palmerpenguins)
```
...
## Set up R enviroment in Quarto {.scrollable}
...
Dataset of Estimated Biological, Hydrologic and Climate Variables for a field site
in the California Sierra


[P301 Watershed](https://czo-archive.criticalzone.org/sierra/infrastructure/field-area/providence-creek-subcatchment-p301/)
