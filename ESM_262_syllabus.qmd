...
knitr::include_graphics(here::here("images/whoIam.jpeg"))
```

## [Course description]{style="color:orange"} {.scrollable}
...
## [Learning objectives]{style="color:orange"} {.scrollable}
...
## [Computing set up]{style="color:orange"} {.scrollable}
...
```{r, sch, echo=FALSE, message=FALSE}
...
schedule <- data.frame(
  ...
  Topic = c(
    ...
    "Documentation",
    "Working with APIs/Command Line",
    "Where does AI fit"
  )
)

# Evening lectures: Tues May 12 and May 19, 2026
# Insert after May 7 (Thu) and May 14 (Thu)
evening_rows <- data.frame(
  Lecture = NA,
  Date = format(as.Date(c("2026-05-12", "2026-05-19")), "%a, %b %e"),
  Type = "Evening",
  Topic = c(
    "Functions!",
...
There will be 6 assignments (more or less one for each week). You will usually have time to start the assignment in class and most will be in groups. We will also have 6 quizes
